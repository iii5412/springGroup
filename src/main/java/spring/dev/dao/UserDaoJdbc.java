...
*/
    ...
    public void add(final User user){//client
        ...
        this.jdbcTemplate.update("insert into users(id, name, password,login,level,recommend,email) values(?,?,?,?,?,?,?)",
                user.getId(),user.getName(),user.getPassword(),user.getLogin(), user.getLevel().intValue(), user.getRecommend(), user.getEmail());
...
/*
    ...
    public void update(User user) {
        this.jdbcTemplate.update(
                ...
                ,user.getName(), user.getPassword(), user.getLevel().intValue(), user.getLogin(), user.getRecommend(), user.getId(), user.getEmail());
