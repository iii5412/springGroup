...
public class UserServiceTest {
    ...
    public void setUp(){
        ...
        users = Arrays.asList(
                new User("bumjun","박범진","p1", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER-1, 0,"a@email.com"),
                new User("joytouch","강명성","p2",Level.BASIC, MIN_LOGCOUNT_FOR_SILVER, 0,"b@email.com"),//승급대상
                new User("erwins","신승한","p3",Level.SILVER, 60, MIN_RECOMEND_FOR_GOLD-1,"c@email.com"),
                new User("madnite1","이상호","p4",Level.SILVER, 60, MIN_RECOMEND_FOR_GOLD,"d@email.com"),//승급대상
                new User("green","오민규","p5",Level.GOLD, 100, Integer.MAX_VALUE,"e@email.com")
        );
    }
